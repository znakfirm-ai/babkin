        ...
        >
          <div
            ...
            style={{
              ...
              borderTop: "1px solid rgba(15,23,42,0.08)",
              boxShadow: "0 -12px 30px rgba(15,23,42,0.2)",
              height: "min(65dvh, calc(var(--app-height, 100dvh) - 20px))",
              minHeight: "min(65dvh, calc(var(--app-height, 100dvh) - 20px))",
              maxHeight: "min(65dvh, calc(var(--app-height, 100dvh) - 20px))",
              display: "flex",
              flexDirection: "column",
              overflow: "hidden",
              paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 8px)",
